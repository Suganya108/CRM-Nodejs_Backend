...
const dbURL = 'mongodb+srv://suganya:Password@cluster0.bg7iy.mongodb.net/CRM?retryWrites=true&w=majority'
...
app.get('/', (req, res) => {
  res.send('<h1>Customer Relationship Management BackEnd..! </h1>')
})
